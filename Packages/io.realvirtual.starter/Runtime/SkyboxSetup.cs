...
namespace realvirtual
{
    public class SkyboxSetup : MonoBehaviour
    {
        ...
        public void Apply()
        {
            ...
            #if UNITY_EDITOR
            var lightingPath = RealvirtualAssetPaths.StarterPackage + "/Assets/Settings/Realvirtual Lighting Settings.lighting";
            var lightingSettingsAsset = AssetDatabase.LoadAssetAtPath<LightingSettings>(lightingPath);
